<script lang="ts">
	...
	let { personen, connecties }: Props = $props();
</script>
...
>
	<Dialog.Content class="overflow-auto">
		<Dialog.Header>
			...
			<div class="flex flex-col">
				<div class="flex flex-row justify-between">
						...
						<ol>
							{#each connecties.filter((c) => {
								...
								<li class="flex flex-col">
									...
									<form
										method="post"
										action="/api/vriendschapsnetwerk/verwijder_connectie"
										onsubmit={async () => await invalidateAll()}
									>
										<input
											type="hidden"
											name="type"
					...
					<div>
						<form
							method="post"
							action="/api/vriendschapsnetwerk/verwijder_persoon"
							onsubmit={async () => await invalidateAll()}
						>
